...
|   |   |
| :---: | :---: |
| <img src="docs/screenshots/mobile-dashboard.png" alt="Дашборд на мобильном full-page evidence" width="100%" /> | <img src="docs/screenshots/mobile-namespaces.png" alt="Неймспейсы на мобильном full-page evidence" width="100%" /> |
