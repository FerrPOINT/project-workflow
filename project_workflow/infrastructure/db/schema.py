...
def ensure_phase_catalog(
    ...
    to match seed order.  Safe to call repeatedly, but the actual sync is
    skipped for a given DB URL after the first successful call per process
    to avoid re-parsing the seed file on every request.
    """
