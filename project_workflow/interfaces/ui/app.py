...
def create_app() -> FastAPI:
    ...
    app.get("/namespace", response_class=HTMLResponse)(pages.namespace_page)
    app.get("/namespace/new", response_class=HTMLResponse)(pages.namespace_new_page)
    app.get("/contexts", response_class=HTMLResponse)(pages.namespace_page)
    app.get("/projects", response_class=HTMLResponse)(pages.namespace_page)
    ...
    app.get("/api/namespaces", response_model=None)(api.api_namespaces)
    app.get("/api/namespaces/{namespace_id}", response_model=None)(api.api_namespace_get)
    app.post("/api/namespaces", response_model=None)(api.api_namespace_create)
    app.put("/api/namespaces/{namespace_id}", response_model=None)(api.api_namespace_update)
    app.delete("/api/namespaces/{namespace_id}", response_model=None)(api.api_namespace_delete)
    app.get("/api/contexts", response_model=None)(api.api_projects)
    app.post("/api/contexts", response_model=None)(api.api_project_create)
    app.put("/api/contexts/{project_id}", response_model=None)(api.api_project_update)
    app.delete("/api/contexts/{project_id}", response_model=None)(api.api_project_delete)
