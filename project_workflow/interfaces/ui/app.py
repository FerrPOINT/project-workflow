...
def create_app() -> FastAPI:
    ...
    app.get("/v2", response_class=HTMLResponse)(pages.v2_runs_page)
    app.get("/v2/{task_key}", response_class=HTMLResponse)(pages.v2_run_detail_page)
    ...
    app.get("/api/v2/runs", response_model=None)(api.api_v2_runs)
    app.get("/api/v2/runs/{task_key}", response_model=None)(api.api_v2_run)
