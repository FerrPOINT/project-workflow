...
The real implementation lives in ``project_workflow.db.compat`` so the CLI
and seed loaders can import ``WorkflowDB`` without pulling in the UI package.
"""
from __future__ import annotations

from ..app_state import _app_state
from ..db.compat import WorkflowDBCompat as _WorkflowDBCompat
