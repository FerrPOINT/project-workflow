...
VISIBLE_TEXT_REPLACEMENTS = (
    ...
    ("бизнес-поведение", "поведение"),
    ("бизнес-задача", "задача"),
    ("бизнес-задачи", "задачи"),
    ("бизнес-задачу", "задачу"),
    ("Business-задача", "задача"),
    ("Business-задачи", "задачи"),
    ("Business-задачу", "задачу"),
    ("Business", "задача"),
    ("Head PR", "head запроса на слияние"),
    ("PR слит", "запрос на слияние слит"),
    ("слитого PR", "слитого запроса на слияние"),
    ("создать PR", "создать запрос на слияние"),
    ("проверку PR", "проверку запроса на слияние"),
    ("проверить PR", "проверить запрос на слияние"),
    ("PR и", "запрос на слияние и"),
    ...
    ("Tech,", "репозиторий,"),
    ("Tech", "репозиторий"),
    ("Maintainer", "ответственный участник"),
