...
from workflow_cli.schema import persist_phase_order_to_seed
from workflow_cli.ui.schemas import (
    AgentCreate,
    AgentUpdate,
    PhaseCreate,
    PhaseOrderUpdate,
...
from workflow_cli.ui.seed import _update_config_phase_order
from workflow_cli.ui.services import _coerce_phase_db_id, _load_phase_detail, _load_tasks
from workflow_cli.ui.skills import _load_skills_catalog as _load_skills_catalog_direct
from workflow_cli.ui.state import _app_state
...
async def api_settings_get() -> dict[str, Any] | JSONResponse:
    ...
    from workflow_cli.ui.services import _load_cli_reference
...
async def api_task_detail(task_key: str) -> dict[str, Any] | JSONResponse:
    from workflow_cli.ui.services import _get_task_detail
...
async def api_projects() -> dict[str, Any] | JSONResponse:
    from workflow_cli.ui.services import _load_projects

    return {"ok": True, "projects": _load_projects()}


async def api_workflows() -> dict[str, Any] | JSONResponse:
    from workflow_cli.ui.services import _load_workflows
...
async def api_phase_update(phase_id: int, payload: PhaseUpdate) -> dict[str, Any] | JSONResponse:
    ...
    from workflow_cli.schema import persist_phase_update_to_seed as _persist_seed
    wdb = _app_state.get_db()
